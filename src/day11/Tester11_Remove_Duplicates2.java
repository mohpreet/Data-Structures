package day11;
//0, 0, 1, 1, 1, 2, 2, 3, 3, 4
public class Tester11_Remove_Duplicates2 {
    public int removeDuplicates(int[] nums) {
        ...
        for (int itr = 2; itr < nums.length; itr++) {
            if (nums[slowPointer] == nums[itr]) {
                ...
                for (int shiftptr=itr;shiftptr-2>slowPointer;shiftptr--){
    ...
    public static void main(String[] args) {
        ...
        int k = new Tester11_Remove_Duplicates2().removeDuplicates(nums); // Calls your implementation
